-- tenant_default.software_identity_metadata is read/written by SoftwareIdentityMetadataService
...
CREATE TABLE IF NOT EXISTS tenant_default.software_identity_metadata (
