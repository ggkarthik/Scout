...
public class QualityIssuePersistenceService {
    ...
    public QualityIssuePersistenceService(
    ...
    public void upsertRows(List<QualityIssueRecord> issues) {
        ...
        tenantSchemaExecutionService.run(issues.get(0).tenantId(), () -> {
            String sql = """
    ...
    public void deleteStaleRows(UUID tenantId, List<QualityIssueRecord> issues) {
        tenantSchemaExecutionService.run(tenantId, () -> {
            ...
            if (issues == null || issues.isEmpty()) {
                jdbcTemplate.update("DELETE FROM quality_issue_projection", params);
                return null;
            }
            ...
            jdbcTemplate.update("""
                    ...
                    WHERE issue_key NOT IN (:issueKeys)
                    """, params);
            return null;
        });
    }
