...
class OperationalDashboardPostgresIntegrationTest {
    ...
    void operationsDashboardExposesEndpointTimingMetricsOnPostgres() throws Exception {
        ...
        mockMvc.perform(get("/api/operations/dashboard")
                ...
                .andExpect(jsonPath("$.apiReadPath.noiseProjectionReady").isBoolean())
                .andExpect(jsonPath("$.apiReadPath.noiseProjectionRefreshP95Ms").isNumber())
                .andExpect(jsonPath("$.apiReadPath.noiseProjectionRefreshFailures").isNumber())
