...
class CorrelationDeterminismPostgresIntegrationTest {
    ...
    private static final LocalPostgresTestDatabase.DatabaseConfig DATABASE =
            LocalPostgresTestDatabase.provision("correlation_determinism");
    ...
    @Test
    void recomputeTwice_producesStableCorrelationFingerprintOnPostgres() throws Exception {
        Tenant tenant = tenantService.getDefaultTenant();
        ...
        Vulnerability vulnerability = createVulnerability("CVE-2099-4001");
        createCpeTarget(
                vulnerability,
                "advisory",
